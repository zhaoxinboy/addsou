...
@property (nonatomic, strong) SJSearchViewModel *searchVM;   /* 删除的网络请求 */
...
- (void)collectionViewdeleteCell:(NSNotification*)noti
{
    ...
    // 网络部分  删除对应链接
    SJHomeAddressDataModel *model = [orignalSection objectAtIndex:indexPath.item];
