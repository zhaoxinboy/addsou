...
-(instancetype)initWithOffsetY:(CGFloat)offsetY
{
    self = [super init];
    if (self) {
        cellWidth = kWindowW - 18 * 2;
        cellHeight = kWindowH - 66;
        self.offsetY = offsetY;
        self.cellLayoutList = [NSMutableArray array];
        
        self.screenHeight = kWindowH;
        self.m0 = 1000;
        self.n0 = 250;
...
-(UICollectionViewLayoutAttributes*)getAttributesWhenLessThan2:(NSIndexPath*)indexPath
{
    ...
    attributes.frame = CGRectMake(SJ_ADAPTER_WIDTH(18), SJ_ADAPTER_HEIGHT(66), cellWidth, cellHeight);
    return attributes;
}
